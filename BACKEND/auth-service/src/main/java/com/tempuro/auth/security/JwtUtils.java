...
public class JwtUtils {
    ...
    /*
    * Value recoge el valor de application properties para asignarlo a la variable de la clase
    */
    ...
    /*
    * La clave secreta y el tiempo de expiración deben guardarse en application properties y nunca subir este archivo en los push
    * La clave secreta se importa y luego se codifica para usarla en la firma, es decir, doble capa de seguridad
